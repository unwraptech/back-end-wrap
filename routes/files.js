...
// get devices with fono API
router.get("/add-devices/fono/android/:name", function (req, res) {
...
// get latest with fono API
router.get("/add-devices/fonol/android/:name", function (req, res) {
    // rola/
...
// get news
router.get("/get-news",async function (req, res) {
